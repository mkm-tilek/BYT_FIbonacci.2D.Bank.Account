...
//		Thought maybe should delete TimedPayments from Array after successful transaction
//		for (String key : timedpayments.keySet()) {
//			if (timedpayments.get(key).tick()) {
//				timedpayments.remove(key);
//			}
//		}
	}
